...
Generated from `npm run check` on 2026-02-14 (Batch 3 follow-up pass).

## Summary

- Total reported TypeScript errors: **213** _(down from 215, -2 in this pass; down from 295, -82 in Batch 3; down from 320, -107 since Batch 2 start; down from 339, -126 overall)_
...
| 2 | TS2322 | 34 | Type is not assignable to target type |
| 3 | TS2393 | 34 | Duplicate function implementation |
| 4 | TS2304 | 27 | Cannot find name |
| 5 | TS2353 | 15 | Object literal has unknown properties |
| 6 | TS2551 | 14 | Property does not exist (near-match suggested) |
| 7 | TS7006 | 5 | Parameter implicitly has `any` type |
| 8 | TS2345 | 4 | Argument type is not assignable |
| 9 | TS2554 | 4 | Expected argument count does not match |
| 10 | TS2552 | 4 | Cannot find name (near-match suggested) |
...
- Follow-up pass fixed `PaymentDialog` nullability (`undefined` -> `null` normalization) and tightened Vite server options typing (`allowedHosts` literal), reducing total errors by 2.
