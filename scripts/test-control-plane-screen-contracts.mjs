...
assertIncludes(settings, "Workspace preferences", "/admin/settings");
assertIncludes(settings, "Saved in this browser only", "/admin/settings");
assertIncludes(settings, "Server-side permissions still apply", "/admin/settings");
