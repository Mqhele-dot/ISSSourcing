...
export const suppliers = pgTable("suppliers", {
  ...
  logisticsContactName: text("logistics_contact_name"),
  email: text("email"),
  phone: text("phone"),
  address: text("address"),
  billingAddress: text("billing_address"),
  remitToAddress: text("remit_to_address"),
  pickupSite: text("pickup_site"),
  deliverySite: text("delivery_site"),
  supplierSites: jsonb("supplier_sites").$type<Array<{ name: string; type?: string; address?: string; contact?: string }>>().default([]),
  ...
  defaultDepartmentId: integer("default_department_id").references(() => departments.id),
  defaultContractId: integer("default_contract_id"),
  defaultCarrierId: integer("default_carrier_id").references(() => carriers.id),
  defaultTransportMode: text("default_transport_mode"),
  billControlPolicy: text("bill_control_policy").default("standard"),
  allowCurrencyOverride: boolean("allow_currency_override").notNull().default(false),
  requireApprovalForOverride: boolean("require_approval_for_override").notNull().default(true),
  riskStatus: text("risk_status").default("unknown"),
