...
export const workflowBlueprintCatalog = [
  ...
  },
  {
    ...
    entityTypes: ["supplier_onboarding", "contract"], stages: ["PO sent", "Awaiting confirmation", "Confirmed", "ETA supplied", "Shipment created"],
  ...
  },
  {
    ...
    entityTypes: ["inventory_adjustment", "inventory_transfer"], stages: ["Awaiting receipt", "Receipt draft", "Quantity verified", "Posted to inventory", "Closed"],
    ...
    workspacePath: "/inventory/warehouse-operations",
  },
  {
