...
export function buildISSSourcingNotificationEmailHtml(title: string, bodyText: string): string {
  ...
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;padding:24px;border:1px solid #e4e4e7;box-shadow:0 1px 3px rgba(0,0,0,.06)">
    <p style="margin:0 0 8px;font-size:11px;text-transform:uppercase;letter-spacing:.08em;color:#71717a">ISSSourcing</p>
