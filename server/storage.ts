...
export class MemStorage implements IStorage {
  ...
  async createStockMovement(insertMovement: InsertStockMovement): Promise<StockMovement> {
    ...
    const movement: StockMovement = {
      ...
      receiverUserId: insertMovement.receiverUserId ?? null,
      receiverName: insertMovement.receiverName ?? null,
      warehouseLocation: insertMovement.warehouseLocation ?? null,
      receivedAt: insertMovement.receivedAt ?? null,
  ...
  async createSupplier(insertSupplier: InsertSupplier): Promise<Supplier> {
    ...
    const supplier: Supplier = {
      ...
      supplierCode: insertSupplier.supplierCode ?? null,
      legalName: insertSupplier.legalName ?? null,
      supplierType: insertSupplier.supplierType ?? null,
      status: insertSupplier.status ?? "active",
      onboardingStatus: insertSupplier.onboardingStatus ?? "prospective",
      createdByUserId: insertSupplier.createdByUserId ?? null,
      approvedAt: insertSupplier.approvedAt ?? null,
      approvedByUserId: insertSupplier.approvedByUserId ?? null,
      isOnceOff: insertSupplier.isOnceOff ?? false,
      onceOffExpiresAt: insertSupplier.onceOffExpiresAt ?? null,
      riskRating: insertSupplier.riskRating ?? "unrated",
      serviceRegions: insertSupplier.serviceRegions ?? [],
      supportedCurrencies: insertSupplier.supportedCurrencies ?? [],
      categoryCodes: insertSupplier.categoryCodes ?? [],
      registrationNumber: insertSupplier.registrationNumber ?? null,
      category: insertSupplier.category ?? null,
      email: insertSupplier.email || null,
      contactName: insertSupplier.contactName || null,
      financeContactName: insertSupplier.financeContactName ?? null,
      logisticsContactName: insertSupplier.logisticsContactName ?? null,
      phone: insertSupplier.phone || null,
      address: insertSupplier.address || null,
      billingAddress: insertSupplier.billingAddress ?? null,
      remitToAddress: insertSupplier.remitToAddress ?? null,
      pickupSite: insertSupplier.pickupSite ?? null,
      deliverySite: insertSupplier.deliverySite ?? null,
      supplierSites: insertSupplier.supplierSites ?? [],
      ...
      taxCodeId: insertSupplier.taxCodeId ?? null,
      incotermId: insertSupplier.incotermId ?? null,
      defaultDepartmentId: insertSupplier.defaultDepartmentId ?? null,
      defaultContractId: insertSupplier.defaultContractId ?? null,
      defaultCarrierId: insertSupplier.defaultCarrierId ?? null,
      defaultTransportMode: insertSupplier.defaultTransportMode ?? null,
      billControlPolicy: insertSupplier.billControlPolicy ?? "standard",
      allowCurrencyOverride: insertSupplier.allowCurrencyOverride ?? false,
      requireApprovalForOverride: insertSupplier.requireApprovalForOverride ?? true,
      riskStatus: insertSupplier.riskStatus ?? "unknown",
      complianceStatus: insertSupplier.complianceStatus ?? "unknown",
      blockedReason: insertSupplier.blockedReason ?? null,
  ...
  async createPurchaseRequisition(
    ...
    const requisitionEntity: PurchaseRequisition = {
      ...
      currencyCode: requisition.currencyCode ?? "ZAR",
      exchangeRateToZar: requisition.exchangeRateToZar ?? 1,
  ...
  async createPurchaseOrder(
    ...
    const orderEntity: PurchaseOrder = {
      ...
      currencyCode: order.currencyCode ?? "ZAR",
      taxCodeId: order.taxCodeId ?? null,
      approvalStatus: order.approvalStatus ?? "DRAFT",
      ...
      sourcingAwardId: order.sourcingAwardId ?? null,
      dispatchStatus: order.dispatchStatus ?? "NOT_SENT",
      dispatchError: order.dispatchError ?? null,
  ...
  async createPurchaseOrderFromRequisition(requisitionId: number): Promise<PurchaseOrder | undefined> {
    ...
    const order: InsertPurchaseOrder = {
      ...
      currencyCode: supplier.defaultCurrencyCode ?? "ZAR",
  ...
  async updateAppSettings(settings: Partial<InsertAppSettings> | Partial<AppSettings>): Promise<AppSettings> {
    ...
    if (existingSettings) {
      ...
      const newSettings: AppSettings = {
        ...
        currencyCode: (settings as Partial<AppSettings>).currencyCode || "ZAR",
