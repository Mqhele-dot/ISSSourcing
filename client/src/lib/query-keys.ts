...
export const qk = {
  ...
  sourcing: ["qk", "sourcing"] as const,
  sourcingEvent: (id: number | string) => ["qk", "sourcing", "event", String(id)] as const,
  sourcingComparison: (id: number | string) => ["qk", "sourcing", "event", String(id), "comparison"] as const,
  supplierSourcing: ["qk", "supplierSourcing"] as const,
  supplierSourcingEvent: (id: number | string) => ["qk", "supplierSourcing", "event", String(id)] as const,
