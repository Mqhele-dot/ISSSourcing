const ROUTE_MARKERS: Array<{ match: (path: string) => boolean; selectors: string[] }> = [
  ...
  { match: (path) => path === "/procurement/quotations/new", selectors: [`[data-testid="commercial-quotation-builder"]`] },
  { match: (path) => path === "/procurement/quotations/supplier-new", selectors: [`[data-testid="quotation-create-page"]`] },
  { match: (path) => path === "/procurement/commercial-quotations", selectors: [`[data-testid="commercial-quotations-page"]`] },
  { match: (path) => /^\/procurement\/commercial-quotations\/\d+\/edit$/.test(path), selectors: [`[data-testid="commercial-quotation-builder"]`] },
  { match: (path) => /^\/procurement\/commercial-quotations\/\d+$/.test(path), selectors: [`[data-testid="commercial-quotation-detail"]`] },
  { match: (path) => /^\/procurement\/quotations\/[^/]+$/.test(path), selectors: [`[data-testid="quotation-review-page"]`] },
  { match: (path) => path === "/procurement/quotations", selectors: [`[data-testid="quotations-page"]`] },
  ...
  { match: (path) => path === "/admin/workflows", selectors: [`[data-testid="workflow-governance-page"]`] },
  { match: (path) => path === "/admin/company-setup", selectors: [`[data-testid="company-setup-page"]`] },
