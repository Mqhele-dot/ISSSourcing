...
export const ANALYTICS_NAV = [
  ...
  { label: "Suppliers", href: APP_ROUTES.analytics.suppliers },
  { label: "Exceptions", href: APP_ROUTES.analytics.exceptions },
  { label: "Diagnostics", href: APP_ROUTES.analytics.diagnostics },
