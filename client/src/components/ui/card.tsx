...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "surface-card min-w-0 overflow-hidden rounded-lg border bg-card text-card-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("min-w-0 flex flex-col space-y-1.5 p-4 sm:p-6", className)}
    {...props}
  />
))
